...
import ru.gothmog.fileupload.util.FileValidator;
...
public class AppController {
    ...
    public String addDocuments(@PathVariable long userId, ModelMap modelMap){
    ...
    public String uploadDocument(@Valid FileBucket fileBucket, BindingResult result, ModelMap modelMap, @PathVariable long userId) throws IOException{
